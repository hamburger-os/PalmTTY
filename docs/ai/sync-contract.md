...
| Session attachments / image preview (`session-artifacts.ts`, `session-artifact-routes.ts`, `image-artifact.ts`, Web Artifacts/Files preview) | `agent.md`, `session.md`, `security.md`, `web-mobile.md`, `roadmap.md` | `architecture.md`, `development.md`, `security.md` | normally none; vendor CLI image syntax is workload behavior, not a PalmTTY standard |
