# Community documentation / 社区开发文档

## English

This layer is for contributors who want to build, review, deploy, or extend PalmTTY. Every substantive document here is bilingual.

- [getting-started.md](getting-started.md) — local build and run workflow
...
这一层面向希望构建、审查、部署或扩展 PalmTTY 的社区开发者，主要文档均保持中英双语。

- [getting-started.md](getting-started.md) — 本地构建与运行
